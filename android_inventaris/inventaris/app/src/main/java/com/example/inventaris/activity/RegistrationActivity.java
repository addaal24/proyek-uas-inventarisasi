package com.example.inventaris.activity;
...
import com.example.inventaris.api.Api;
import com.example.inventaris.api.ApiClient;
import com.example.inventaris.model.UserRegistrationModel;
        ...
        call.enqueue(new Callback<UserRegistrationModel>() {
            ...
            public void onResponse(Call<UserRegistrationModel> call, Response<UserRegistrationModel> response) {
                if (response.isSuccessful()) {
                    ...
                    Intent intent = new Intent(RegistrationActivity.this, com.example.inventaris.activity.LoginActivity.class);
