...
public class User implements Serializable {
    ...
    private Set<com.example.inventaris.model.Role> roles = new HashSet<>();
    ...
    public Set<com.example.inventaris.model.Role> getRoles() {
        return roles;
    }

    public void setRoles(Set<com.example.inventaris.model.Role> roles) {
        this.roles = roles;
    }
}
